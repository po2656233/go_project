...
func init() {
	...
	// 游戏结束
	handlerMsg(&protoMsg.BaccaratStateOverResp{}, handleBaccaratStateOverResp)         //反馈--->主页信息
	handlerMsg(&protoMsg.BrcowcowStateOverResp{}, handleBrcowcowStateOverResp)         //反馈--->主页信息
	handlerMsg(&protoMsg.BrtoubaoStateOverResp{}, handleBrtoubaoStateOverResp)         //反馈--->主页信息
	handlerMsg(&protoMsg.BrTuitongziStateOverResp{}, handleBrTuitongziStateOverResp)   //反馈--->主页信息
	handlerMsg(&protoMsg.TigerXdragonStateOverResp{}, handleTigerXdragonStateOverResp) //反馈--->主页信息
	handlerMsg(&protoMsg.ZhajinhuaStateOverResp{}, handleZhajinhuaStateOverResp)       //反馈--->主页信息
	handlerMsg(&protoMsg.MahjongStateOverResp{}, handleMahjongStateOverResp)           //反馈--->主页信息
	handlerMsg(&protoMsg.MahjongERStateOverResp{}, handleMahjongERStateOverResp)       //反馈--->主页信息
	handlerMsg(&protoMsg.MahjongCSStateOverResp{}, handleMahjongCSStateOverResp)       //反馈--->主页信息
	handlerMsg(&protoMsg.MahjongGDStateOverResp{}, handleMahjongGDStateOverResp)       //反馈--->主页信息
	handlerMsg(&protoMsg.MahjongSCStateOverResp{}, handleMahjongSCStateOverResp)       //反馈--->主页信息
	handlerMsg(&protoMsg.MahjongXZDDStateOverResp{}, handleMahjongXZDDStateOverResp)   //反馈--->主页信息
	handlerMsg(&protoMsg.MahjongXLCHStateOverResp{}, handleMahjongXLCHStateOverResp)   //反馈--->主页信息
	handlerMsg(&protoMsg.LandLordsStateOverResp{}, handleLandLordsStateOverResp)       //反馈--->主页信息
	handlerMsg(&protoMsg.PaoDeKuaiStateOverResp{}, handlePaoDeKuaiStateOverResp)       //反馈--->主页信息
	handlerMsg(&protoMsg.TuitongziStateOverResp{}, handleTuitongziStateOverResp)       //反馈--->主页信息
	...
	if person.UserID == m.UserID {
		...
		time.AfterFunc(time.Duration(second.Int64())*time.Second, func() {
			...
			case 0:
				...
				a.WriteMsg(msg)
			case 1:
				scoreR, _ := rand.Int(rand.Reader, big.NewInt(1000))
				score := (scoreR.Int64() + 1) * 100
...
// 有进进出出的效果
// ////////////////////////离开游戏/////////////////////////
func randomLeaveGame(a gate.Agent) {
	r, _ := rand.Int(rand.Reader, big.NewInt(100))
	if 0 == r.Int64()%2 {
		person := a.UserData().(*protoMsg.UserInfo)
		r, _ := rand.Int(rand.Reader, big.NewInt(10))
		wait := time.Duration(r.Int64() + 1)
		time.AfterFunc(wait*time.Second, func() {
			a.WriteMsg(&protoMsg.ExitGameReq{
				GameID: person.AgentID,
			})
		})
...
// ////////////////////////////////////////////////////
func handleBaccaratStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleBrcowcowStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleBrtoubaoStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleBrTuitongziStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleTigerXdragonStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleZhajinhuaStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleMahjongStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleMahjongERStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleMahjongCSStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleMahjongGDStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleMahjongSCStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleMahjongXZDDStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleMahjongXLCHStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleLandLordsStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handlePaoDeKuaiStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
}
func handleTuitongziStateOverResp(args []interface{}) {
	a := args[1].(gate.Agent)
	if a.UserData() != nil {
		randomLeaveGame(a)
	}
